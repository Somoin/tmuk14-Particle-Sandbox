...
text_display = TextDisplay(window, "", [window_width - 350, window_height - 710], (255, 255, 255))
...
sand_button = Button("src/images/sandbutton.png", [200, 500], "src/images/sandbutton_hover.png", button_width, button_height)
water_button = Button("src/images/waterbutton.png", [400, 500], "src/images/waterbutton_hover.png", button_width, button_height)
concrete_button = Button("src/images/concretebutton.png", [600, 500], "src/images/concretebutton_hover.png", button_width, button_height)
fire_button = Button("src/images/firebutton.png", [800, 500], "src/images/firebutton_hover.png", button_width, button_height)
wood_button = Button("src/images/woodbutton.png", [900, 500],"src/images/woodbutton_hover.png", button_width, button_height)
gunpowder_button = Button("src/images/gunpowderbutton.png", [1000, 500], "src/images/gunpowderbutton_hover.png", button_width, button_height)
